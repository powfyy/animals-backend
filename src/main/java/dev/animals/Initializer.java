...
public class Initializer {
  ...
  public void initial() {
    ...
    if (animalRepository.count() == 0) {
      ...
      dto.setDescription("Отдаётся в добрые и заботливые руки красивый голубой волнистый попугайчик. " +
        "Это умная, жизнерадостная и очень любознательная птичка, которая обязательно принесёт в ваш дом радость и уют. " +
        "Попугай ещё совсем молодой — ему около месяца, он здоров, активен и ухожен. У него редкий и очень " +
        "красивый голубой окрас с мягкими белыми и чёрными узорами на крылышках. Птичка быстро привыкает к людям, любит " +
        "наблюдать за всем, что происходит вокруг, с интересом откликается на разговоры и звуки. Иногда тихонько чирикает " +
        "и может подражать простым звукам, а при терпеливом и добром отношении вполне может научиться словам. " +
        "Он не боится подходить ближе, проявляет интерес к рукам, а значит, при должном внимании вполне может стать ручным. " +
        "Если вы чувствуете, что готовы подарить этой прекрасной птичке заботу и внимание — звоните или пишите. " +
        "Попугайчик очень ждёт встречи со своим новым домом. Мы находимся в Воронеже, возможна доставка по договорённости.");
